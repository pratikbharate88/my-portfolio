...
import { SiKubernetes, SiTerraform, SiAnsible, SiPrometheus, SiGrafana, SiGitlab, SiGooglecloud } from 'react-icons/si';
  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "Gitlab", icon: <SiGitlab className="skill-icon" style={{ color: '#fc6d26' }} /> },
      ]
    },
    {
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Google Cloud", icon: <SiGooglecloud className="skill-icon text-danger" /> }
      ]
    },
    {
