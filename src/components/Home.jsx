          ...
          <Row className="align-items-center">
            ...
            <Col lg={8} className="text-center text-lg-start">
              ...
              <div className="lead mb-5 typing-animation">
                <p>I'm a passionate Cloud enthusiast and aspiring DevOps Engineer with hands-on experience in building and deploying full-stack applications using tools like Docker, Jenkins, AWS, and Kubernetes.</p>
